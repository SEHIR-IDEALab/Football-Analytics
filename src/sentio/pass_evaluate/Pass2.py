...
class Pass:
    ...
    def __init__(self):
        self.teams = None
        # self.weight_coefficient=[947, 776, 269]
        # self.weight_coefficient = [6, -2, 3910]
        # self.weight_coefficient = [489, 975, 572]
    ...
    def passAdvantage(self, p1,risk_ignore):
        ...
        for p2 in own_team.getTeamPlayers():
            if p1.getJerseyNumber() != p2.getJerseyNumber():
                pa = ((10 + self.gain(p1, p2)) / (10 + self.overallRisk(p1, p2,risk_ignore)))
    ...
    def effectiveness(self, p1, p2,weight_coefficient):
        # w1, w2, w3, w4 = 1, 1, 1, 1
        w1, w2, w3 = weight_coefficient
        effectiveness = w1 * self.gain(p1, p2) + w2 * self.passAdvantage(p2)[0] + w3 * self.goalChance(p2)
