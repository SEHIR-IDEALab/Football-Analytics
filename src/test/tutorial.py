...
class ExamplePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.play_speed_slider = wx.Slider(self, -1, value=0.5, minValue=0.5, maxValue=9.5,
                                      style=wx.SL_HORIZONTAL|wx.SL_VALUE_LABEL | wx.SL_TOP | wx.SL_SELRANGE)
        ...
        mainSizer.Add(self.play_speed_slider)
        self.SetSizerAndFit(mainSizer)

    def on_play_speed_slider(self, event):
        print self.play_speed_slider.GetValue()
